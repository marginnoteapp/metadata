...
const dict: Dict = {
  ...
  handle_user_action: {
    gesture: {
      alert:
        "This feature is provided by Metadata and not related to MarginNote. Have you read the doc and are aware of the specific gesture monitoring areas and the risks associated with their use?",
