...
const en: typeof zh = {
  link: "https://www.notion.so/huangkewei/metadata-wiki-faea66243fb54149b9e7067f61142a9d",
  option: {
  ...
  help: {
    ...
    has_title_then:
      "Drag and drop the selection to merge into the card, and if a new title will be created by metadata, then"
  }
}
